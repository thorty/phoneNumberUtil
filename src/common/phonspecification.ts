// not used atm
const prefixMobileGerman: string[] = [
    "0150",
    "0151",
    "0152",
    "0155",
...
const maxlenghtMobileGerman: number = 15; //without 0
const minlengthMobileGerman: number = 6 // todo: check

const prefixFixedlineGerman: string[] = [
    "030",
    "040",
    "069",
    "089",
...
const cuntrys: Array<ICountrycode> =
    [
        ...
        { "CountryCode": "GB", "CountryName": "United Kingdom of Great Britain and Northern Ireland" },
